...
iso_name="hzlinux"
iso_label="HZLIN_$(date --date="@${SOURCE_DATE_EPOCH:-$(date +%s)}" +%Y%m)"
iso_publisher="HaoZeke <https://github.com/HaoZeke>"
iso_application="HaoZeke Arch Linux Live/Rescue ISO"
